...
\begin{tabular}{p{4cm}|p{14cm}} % <=============================
  ...
  \begin{tabular}[t]{@{}l@{}}\parbox{\datebox}{Oct 2021 - Present}
  \end{tabular}
  ...
  \normalsize\texttt{Laboratoire Matière et Systèmes Complexes, Université Paris Cité}  $\cdotp$ \textit{Paris}\\[0.2cm]
	...
	& \footnotesize\textbf{Subject:} Self-organization and morphogenesis of active mixtures\\
	& \footnotesize\textbf{Supervisor:} Julien Tailleur \ %$|$ \ \textit{External collaboration:} Mehran Kardar%
	\end{tabular}\\[0.5cm]
